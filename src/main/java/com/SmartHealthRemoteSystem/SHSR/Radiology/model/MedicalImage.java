...
@Document(collection = "MedicalImage")
@TypeAlias("com.SmartHealthRemoteSystem.SHSR.Radiology.MedicalImage")
public class MedicalImage {
    ...
    public MedicalImage(String id, String requestId, String patientId, String uploadedBy,
    ...
    public static class Builder {
        ...
        public MedicalImage build() {
            return new MedicalImage(id, requestId, patientId, uploadedBy,
