...
public class Message {
    ...
    public Message(String messageId, String chatId, String senderId, String content,
                   String imagingReferenceId, String reportId, String reportLink,
    ...
    public static class Builder {
        ...
        public Builder reportLink(String reportLink)                 { this.reportLink = reportLink; return this; }
        ...
        public Message build() {
            return new Message(messageId, chatId, senderId, content,
                    imagingReferenceId, reportId, reportLink, status, timestamp);
        }
    }
}
